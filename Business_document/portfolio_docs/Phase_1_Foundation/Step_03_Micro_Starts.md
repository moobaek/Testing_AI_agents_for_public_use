...
```
Step 3: 초소형 단위의 시작을 수행해주세요.

**Phase ID**: `phase.foundation.step03`
**목표**: 1~2시간 내에 결과물이 나오는 아주 작은 기능부터 구현하여 빠르게 검증

**요구사항**:
1. 초소형 프로젝트 아이디어 제안 (1~2시간 완성 가능)
2. 최소 기능 제품(MVP) 설계
3. 빠른 프로토타입 구현 가이드
4. 검증 방법 및 피드백 수집 전략
...
**ID 규칙**:
- 프로젝트 ID: `project.micro.[name]`
- 기능 ID: `feature.micro.[name]`
- 검증 ID: `validation.micro.[name]`
```

### 프롬프트 사용 예시

**사용자 요청**: "1~2시간 안에 완성할 수 있는 작은 프로젝트를 제안해줘"

**AI 동작**:
1. 사용자의 전문 분야 및 목표 분석
2. 초소형 프로젝트 아이디어 제안
3. 각 프로젝트별 구현 가이드 제공
4. 검증 방법 제시
5. 다음 단계 제안
