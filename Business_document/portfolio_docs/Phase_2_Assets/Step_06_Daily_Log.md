...
```
Step 6: 데일리 로그 기록을 수행해주세요.

**Phase ID**: `phase.assets.step06`
**목표**: 실행 과정에서 발생하는 모든 시행착오, 성공, 오류를 구조화된 자산으로 기록

**요구사항**:
1. 데일리 로그 템플릿 설계
2. 시행착오 기록 방법 정의
3. 성공 사례 자산화 전략
4. 로그 검색 및 재사용 시스템 구축
...
**ID 규칙**:
- 로그 ID: `log.daily.[YYYYMMDD]`
- 이슈 ID: `issue.[category].[name]`
- 해결책 ID: `solution.[category].[name]`
```

### 프롬프트 사용 예시

**사용자 요청**: "오늘 작업한 내용을 구조화된 로그로 기록하는 방법을 알려줘"

**AI 동작**:
1. 데일리 로그 템플릿 제안
2. 오늘의 작업 내용 구조화
3. 시행착오 및 해결책 기록
4. 향후 재사용을 위한 태깅 및 분류
