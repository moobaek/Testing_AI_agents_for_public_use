...
- [[../Testing_Context|Enterprise Pilot Reports]] - 실증 사례의 시각적 기록
...
```
Step 7: 시각적 자산 생성을 수행해주세요.

**Phase ID**: `phase.assets.step07`
**목표**: 텍스트 로그를 카드 뉴스, 영상, 흐름도 등 시각적 콘텐츠로 변환

**요구사항**:
1. 텍스트를 시각 자료로 변환하는 전략
2. Mermaid 다이어그램 생성 가이드
3. 프레젠테이션 자산 생성 방법
4. 시각 자료 관리 체계
...
**ID 규칙**:
- 다이어그램 ID: `diagram.[type].[name]`
- 시각 자산 ID: `asset.visual.[name]`
- 프레젠테이션 ID: `presentation.[topic].[name]`
```

### 프롬프트 사용 예시

**사용자 요청**: "텍스트 문서를 시각적 다이어그램으로 변환해줘"

**AI 동작**:
1. 텍스트 내용 분석
2. 적절한 다이어그램 유형 선택 (flowchart, sequence, gantt 등)
3. Mermaid 다이어그램 생성
4. 시각 자료 최적화 제안
