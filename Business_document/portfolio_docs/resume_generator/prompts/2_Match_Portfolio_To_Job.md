...
- `00_Team_Vision.md` → `portfolio/portfolio_docs/00_Team_Vision.md`
...
- **입력 2**: `00_Team_Vision.md`
- **입력 3**: `02_Solution_Suite.md`
...
**처리 방법**:
1. 필수 문서 확인 (00_Team_Vision.md, 02_Solution_Suite.md)
2. 사용자에게 문서 위치 확인 요청
3. 가능한 문서만으로 매칭 시도
