...
**"2020년부터 2025년까지 5년간, 제조·에너지·헬스케어 산업의 디지털 전환(DX)을 위한 20개 이상의 AI 기반 솔루션을 개발하고, 대기업에 납품하며, 9편의 R&D 기술 검증으로 기술력을 검증받은 실전형 AI 엔지니어입니다."**

> [!TIP] 핵심 철학
> **"모델보다 데이터, 데이터보다 정보, 지식구조를 정리하는 현장친화적 연구원"**  
> 단순한 모델 개발을 넘어, 데이터를 정보로 전환하고 지식 구조를 체계화하는 데 집중합니다. [[00_Team_Vision|팀 비전 상세 보기]]
...
### 이 포트폴리오를 더 자세히 보려면
1. **팀 비전**: [[00_Team_Vision|핵심 역량 및 철학 상세]]
2. **솔루션 상세**: [[02_Solution_Suite|20개 이상 솔루션 전체 보기]]
