...
- **핵심 문서**: 경영진 요약, 팀 비전, ID 시스템 가이드 등
- **프로젝트 문서**: 솔루션 스위트, 아키텍처 개요, R&D 기술 검증 등
...
- [[00_Portfolio_Index|00_Executive_Summary.md]] (`page.portfolio.index`) - 포트폴리오 전체 인덱스

### 추가 정보
- [[00_ID_System_Guide|00_ID_System_Guide.md]] (`guide.id.system`) - ID 시스템 가이드
- [[00_AI_Workflow_Guide|00_AI_Workflow_Guide.md]] (`guide.ai.workflow`) - 자율 개발 라이프사이클
```
