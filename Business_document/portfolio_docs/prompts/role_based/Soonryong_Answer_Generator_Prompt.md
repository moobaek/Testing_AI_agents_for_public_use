...
- **격식있지만 따뜻한 어조 사용**: ~입니다, ~습니다 중심 사용, ~이에요, ~거든요, ~네요, ~는데요는 자연스러운 경우에만 최소한 사용
- **반말 사용 금지**: ~야, ~해, ~이거든, ~잖아 등은 절대 사용하지 않음
- **면접관/비즈니스 맥락에 적합한 격식있는 톤 유지**: 대화하듯이 자연스럽게 설명하되, 격식있는 어조 유지
- **상세하고 친절한 설명**: 요약이 아닌 직접적인 설명
- **비즈니스/기술 도메인에 맞는 비유 활용**: 일상적인 비유보다는 비즈니스나 기술 맥락에 맞는 예시 사용
- **기술 용어는 쉬운 설명과 함께 제공**
- **대화형 표현 적절히 사용**: "그런데", "아, 그렇다면", "음, 이건", "아, 맞습니다" 등 자연스러운 전환 표현 사용
...
- 자연스러운 대화 흐름에서만 "~이에요", "~거든요" 최소한 사용
- 면접관/비즈니스 맥락에 적합한 정중한 톤 유지

**표현 패턴**:
- 질문 의미 정리 및 핵심 답변: "[질문 의미 정리] 실제로 [경험 사례]에서 이런 경험이 있었습니다."
- 주제 전환: "그런데 [주제]에 대해서는 이렇게 생각해볼 수 있습니다."
- 설명 전환: "아, 그렇다면 [설명 내용]입니다."
- 중요 사항 강조: "이 부분은 정말 중요합니다. 실제로는 [구체적 설명]입니다."
...
> 격식있지만 따뜻한 어조를 사용합니다. "~입니다", "~습니다" 중심으로 작성하며, "~이에요", "~거든요"는 자연스러운 대화 흐름에서만 최소한 사용합니다. "그런데", "아, 그렇다면", "음, 이건", "아, 맞습니다" 같은 대화형 표현을 자연스럽게 포함하되, 면접관/비즈니스 맥락에 적합한 격식있는 어조를 유지합니다.
...
- **스타일**: 학술적 근거 및 검증 중심
- **포함 내용**: 연구 방법론, R&D 기술 검증 인용, 이론적 배경, 검증 과정 및 결과
