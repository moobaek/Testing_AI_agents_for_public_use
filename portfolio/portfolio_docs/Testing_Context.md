...
## 🏭 4. 스마트공장 구축 프로젝트 실증 (2020-2026)

> [!INFO] **23개 프로젝트 실증 현황**
> 중소기업 스마트 제조 혁신을 위한 AI 솔루션 납품 및 실증. 품질 예측, 공정 최적화, 에너지 관리 등 다양한 영역.

### 4.1 AMS/CoCTK 납품 실증

#### 에스에이치아이엔티 (자동차 부품) - AMS 납품
- **기간**: 2024-07 ~ 2024-10
- **납품 시스템**: AMS (Analysis Management System)
- **실증 내용**: 품질 예측 엔진, 이상 모니터링 체크 기준 엔진
- **성과**: 사출공정 품질 AI 이상감지 시스템 구축 완료

#### 테이패스 새만금 (플라스틱) - CoCTK 납품
- **기간**: 2025-04 ~ 2026-01 (진행중)
- **납품 시스템**: CoCTK (Consulting Tool Kit)
- **실증 내용**: 품질 요구사항 분석, AI 기반 공정 최적화
- **성과**: GS 1등급 인증 솔루션 납품

### 4.2 주요 업종별 실증 현황

| 업종 | 프로젝트 수 | 대표 사례 | 핵심 솔루션 |
|:---|:---:|:---|:---|
| **자동차 부품** | 4 | 에스에이치아이엔티, 한중엔시에스 | AMS, FBS, 품질 예측 |
| **금형/금속** | 3 | 진영정기, 대성금형 | 시뮬레이션, 품질 OUT 예측 |
| **화장품** | 2 | 에이치피앤씨 | 배합 최적화, 시계열 예측 |
| **식품** | 3 | 해태가루비, 알티스트 | Frying 공정 최적화 |
| **철강** | 2 | 롯데알루미늄 | QMS, 레시피 최적화 |
| **섬유/인쇄** | 3 | 송월타올, 다마요팩 | ARIMA+AI 시계열 |
| **에너지** | 1 | 우일염직 | HMI 에너지 최적화 |
...
- ✅ **GS 1등급 인증 솔루션 적용**: AMS/PDS, CoCTK

**관련 문서**: [[02_Projects_Overview#스마트공장|스마트공장 구축 프로젝트 상세]]
