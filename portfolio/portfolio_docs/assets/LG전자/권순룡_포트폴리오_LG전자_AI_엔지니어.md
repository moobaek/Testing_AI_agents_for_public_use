...
```mermaid
graph TB
    subgraph "포트폴리오 (5대 영역, 20개+ 프로젝트)"
        Root[권순룡 포트폴리오]
        
        subgraph "AI & Analytics"
            AMS[AMS<br/>AI 종합 플랫폼]
            CoCTK[CoCTK<br/>비용 최적화]
            FBS[FBS<br/>피쉬본 자동화]
        end
        ...
        subgraph "AI Workflow"
            FMEA[FMEA 자동화<br/>8개 Sub-Agent]
            Eval[Evaluation_Framework<br/>LangGraph]
        ...
        subgraph "Sensors & IoT"
            Smart[스마트센서 3종]
            AIComposite[AI 복합 센서]
        end
        
        subgraph "Safety & Energy"
            Cleanroom[클린룸 에너지<br/>20% 절감]
            Power[전력 데이터 예측]
        end
    end
...
graph LR
    subgraph "5년간의 성과 (2020-2025)"
        ...
        B[20개 이상<br/>프로젝트]
        C[9편<br/>논문 발표]
        D[정식 납품<br/>세아특수강/포미아]
        E[이상 탐지율<br/>93.7%]
        F[49개 Python<br/>모듈 개발]
        G[8개 Sub-Agent<br/>협업 구조]
        H[LangGraph<br/>오케스트레이션]
    end
...
timeline
    ...
    2022 : CoCTK 엔진 총괄 설계 및 개발
         ...
         : 진료기록 체질 분석 시스템
         : 생산정보 연계 통합 운영관리
    2023 : 산업용 클린룸 에너지 최적화 (20% 절감)
         : 생산공정 에너지 데이터 패턴 분석
         : 압축기 공정 데이터 밸런스 문제 해결
    2024 : AMS AI 종합 플랫폼 개발 총괄 PM
         : Evaluation_Framework 개발 (LangGraph)
         : 프롬프트 평가 엔진 개발
         : 세아특수강/포미아 정식 납품
    2025 : FMEA 자동화 생성 시스템 (8개 Sub-Agent)
         : PM Agent 개발 (MCP 기반)
...
```mermaid
graph TB
    subgraph "AI Workflow & Automation (LG전자 채용 공고 핵심 매칭)"
        FMEA[FMEA 자동화<br/>8개 Sub-Agent 협업<br/>relevance: 98]
        Eval[Evaluation_Framework<br/>LangGraph 오케스트레이션<br/>relevance: 95]
    ...
    subgraph "AI & Analytics"
        AMS[AMS<br/>49개 Python 모듈<br/>relevance: 75]
        CoCTK[CoCTK<br/>GS 1등급<br/>relevance: 70]
        FBS[FBS<br/>피쉬본 자동화<br/>relevance: 65]
    end
    
    subgraph "Digital Platforms"
        DPS[DPS<br/>5층 아키텍처<br/>relevance: 70]
    end
