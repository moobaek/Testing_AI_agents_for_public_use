...
graph TB
    subgraph "핵심 AI Agent 프로젝트 (Job Relevance 높은 순)"
        ...
        PROMPT[프롬프트 평가 엔진<br/>relevance_score: 95<br/>AI Gatekeeper<br/>25개+ 프롬프트 전수 평가<br/>이중 검증 구조]
        ORIGIN[Original Development Plan<br/>relevance_score: 92<br/>코딩 에이전트<br/>LangGraph/CrewAI<br/>워크플로우 오케스트레이션]
        VCC[Virtual Company<br/>Creation Agent<br/>relevance_score: 90<br/>Dual-Tier AI 아키텍처<br/>GFS 특화 DB<br/>87% 비용 절감]
        FACTORY[Factory Ontology<br/>Manager AI Agent<br/>relevance_score: 88<br/>자연어 파싱<br/>DB Grounding<br/>Ontology Mapping]
        PM[PM Agent<br/>relevance_score: 85<br/>MCP 기반 시스템<br/>32개 MCP 서버<br/>사업 관리 자동화]
        DOC[Business Document<br/>Generator<br/>relevance_score: 82<br/>문서 자동 생성<br/>발주처 유형별 페르소나<br/>이력 포폴 자동 생성]
    end
    
    subgraph "기반 기술"
        AMS[AMS<br/>relevance_score: 70<br/>베이지안 네트워크<br/>이상 탐지 93.7%]
        DPS[DPS<br/>relevance_score: 65<br/>5층 아키텍처<br/>Neo4j GraphDB]
        CoCTK[CoCTK<br/>relevance_score: 60<br/>모듈화 체계화<br/>GS 인증 1등급]
    end
