...
AMS는 데이터 수집부터 이상 탐지, FMEA 생성까지의 전체 파이프라인을 담당하는 핵심 분석 엔진입니다. (상세 내용은 하단 'AMS 시스템 아키텍처' 섹션 참조)

### 2. Digital Transformation Platform: DPS (Digital Production System)
금속 공정(轧制, 충压 등) 자동화를 위한 **모듈화 5층 아키텍처**입니다. 
...
클린룸 및 공장 에너지 효율화를 위한 AI 최적화 엔진입니다. (**GS 인증 획득**)
...
- [Step 1: 반복적 업무 식별](Phase_1_Foundation/Step_01_Repetitive_Work.md) - 문서 구조 중심 개발 시스템
- [Step 4: 모듈화 전략](Phase_1_Foundation/Step_04_Modularization.md) - ID 시스템 및 프롬프트 라이브러리
- [Step 5: I/O 최적화](Phase_1_Foundation/Step_05_IO_Optimization.md) - 파일 기반 파이프라인
- [Testing Context](Testing_Context.md) - 테스트 및 시연 사례
